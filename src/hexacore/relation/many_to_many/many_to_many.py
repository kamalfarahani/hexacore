"""Collect commands for operations on many-to-many relations."""

from hexacore.entity import Entity

from ..base_relation import BaseRelation
from .commands import Create, GetLefts, GetRights, Unlink, UpdateLeft, UpdateRight


class ManyToMany[L_ID, R_ID, L: Entity, R: Entity](BaseRelation):
    """Represent a relation between many left and many right entities.
    ...
    def create(self, left_id: L_ID, right_id: R_ID) -> None:
        """Append a command to link one left entity to one right entity.
    ...
    def get_lefts(self, right_id: R_ID) -> None:
        """Append a command to retrieve all left entities linked to a right entity.

        Args:
            right_id: Identifier of the right entity whose left entities are requested.
        """
        self.add_command(GetLefts[R_ID](right_id=right_id))
    ...
    def update_left(self, right_id: R_ID, left: L) -> None:
        """Append a command to update one left entity linked to a right entity.
